...
begin
    ...
    try
        ...
        begin
            ...
            // empleado es de categoría cuatro. Lo abstraigo
            // en un procedimiento porque debo hacerlo por
            // fuera de este ciclo. Explicado justo abajo.
            procesar_registro();
            read(entrada, reg_emp);
        end;
        ...
        // Muestro los nombres de los empleados y cierro
